...
transiciones = [
    ...
    ("solicitar_oferta_provedoores", "proveedor_envia_ofertn", "Pedido en regla", "IoTBD-Compras"),
    ("proveedor_envia_ofertn", "consulta_acep_oferta", "Se manda la petición de oferta", "Proveedor"),
    ("consulta_acep_oferta", "negociacion_proveedores", "El proveedor envía la oferta", "IoTBD-Responsable Técnico solicitud"),
    ("negociacion_proveedores", "proponer_proveedor", "Una vez la oferta se consulta", "IoTBD-Compras"),
    ("proponer_proveedor", "aprobar_adjuducacion", "Una vez se analizan las ofertas", "IoTBD-Compras"),
    ("aprobar_adjuducacion", "facturar", "Una vez elegido el proveedor se cierra", "IoTBD-Directora"),
    ("facturar", "fin", "Se contabiliza la factura", "IoTBD-Finanzas"),
]
